...
import EmperorFishScene from "../EmperorFishScene/EmperorFishScene.jsx";
...
const Intro03 = forwardRef(({ isDarkMode, onViewProjects }, ref) => {
...
Intro03.displayName = "Intro03"; // For React devtools
